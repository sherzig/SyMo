...
* Download the latest build from the repository ["build 108":https://github.com/sherzig/SyMo/blob/master/builds/MagicDraw_-_ModelCenter_Plugin_17.0.2_108.zip]
